...
7. **Merge sequenziell:** ein Paket nach dem anderen mergen — davor pro Paket der mechanische Check:
   `.claude/skills/_shared/scripts/merge-check.sh <base> --zone <karten-zone>… --allow project/ --test-cmd "<voll-Test aus PROFILE>"`.
...
`~/Projekte/Skills/_shared/knowledge/` (falls vorhanden; Format siehe deren README).
